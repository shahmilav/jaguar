...
public class AuthUtil {
     ...
     *
     * <p>
     * The longer the stronger (against <a
     * href="https://www.kaspersky.com/resource-center/definitions/brute-force-attack">brute-force
     * attacks</a>), however if it is too high, the process becomes very slow
     * and an unpleasant experience as this happens <strong>every time passwords
     * are entered.</strong>
     */
     ...
     * secured password.
     *
     * Use this during registration time.
     *
    ...
    /**
     * 
     * This method will return a hashed password when you pass plain text password and salt.
     * You then compare the hashed password generated from this method with the one stored in the database.
     * If both passwords match, then you should allow the user to login.
     * 
     * It runs 1000 iterations of hash. Use this during login time.
     *
     ...
     */
    public static String createSecurePasswordGivenSalt(String password, String salt) throws PasswordGenException {
        try {
