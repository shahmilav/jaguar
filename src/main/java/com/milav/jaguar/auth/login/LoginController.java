...
public class LoginController {
     ...
     * <li>If the user does not exist, it sends an error message and returns
     * null.
     * <li>If any fields are blank, it sends an error message and returns null.
     * <li>If the user enters the right password, the method redirects the user
     * to their dashboard and starts their session.
     * <li>If the user enters the wrong password, an error message is shown and
     ...
     *
     * <p>
     * If the user is not logged in, the method redirects them to the login
     * page. Otherwise, we ensure the user exists. If they exist, we show a
     * welcome message on the dashboard. If they do not exist, we redirect them
     * to the login page.
     *
     * @param model model
     * @param session HttpSession
